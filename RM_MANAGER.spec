...
binaries = []
hiddenimports = ['plotly', 'PIL', 'PIL.Image', 'PIL.ImageTk', 'PIL.ImageDraw', 'PIL.ImageFilter', 'ortools', 'ortools.sat', 'ortools.sat.python', 'ortools.sat.python.cp_model', 'psutil', 'anthropic', 'rm_ai_optimizer', 'matplotlib', 'matplotlib.backends.backend_agg', 'db', 'stats_status', 'stats_project_summary', 'openpyxl', 'openpyxl.styles', 'openpyxl.cell._writer']
